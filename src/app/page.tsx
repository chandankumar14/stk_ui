      ...
      <main className="py-20 sm:py-20 md:py-20 ">
        ...
        font-sans before:absolute
         ...
         before:h-full before:inset-0
          ...
          before:z-10">
            <img src="https://media.samyakk.com/pub/media/magestore/bannerslider/images//0/5/05_7.jpg"
              alt="Banner Image" className="absolute inset-0 w-full h-full object-cover" />

            <div className="min-h-[360px] relative z-50 h-full max-w-6xl
          ...
          <div className="font-sans">
            <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-gray-100">
              ...
              <div className="lg:h-[480px] flex items-center">
                <img src="https://media.samyakk.com/pub/media/wysiwyg/codilar/Lehenga-saga/image_6.png"
                  className="w-full h-full object-cover" alt="Dining Experience" />
              </div>
            </div>
