    ...
    <>
      ...
      <div className="container px-10">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 mt-8">
          {products.map((product) => (
            <div key={product.id}  className="border border-gray-200">
              <div className="text-center border-b border-gray-200 w-5/6 h-[210px] overflow-hidden mx-auto aspect-w-16 aspect-h-8 md:mb-2 mb-4">
                <Image src={product.image}
                  width={200}
                  height={200}
                  alt="Product 1"
              ...
              <div className="px-8 py-4">
                <p className="text-gray-500 text-[14px] font-medium">{product.title}</p>
                <div className="flex justify-between items-center mt-4">
                  <h2 className="font-medium text-accent text-xl">${parseFloat(product.price).toFixed(2)}</h2>
