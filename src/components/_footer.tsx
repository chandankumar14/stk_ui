  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        >
          <strong className="text-xl text-white sm:text-xl"> Make Your Choice! </strong>
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="text-center sm:text-left">
            ...
            <ul className="mt-8 space-y-4 text-sm">
              ...
              <li>
                <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> WHAT'S NEW </a>
              </li>
              ...
              <li>
                <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> SAREES </a>
              </li>
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-gray-900">Shop Now</p>
            ...
            <ul className="mt-8 space-y-4 text-sm">
              ...
              <li>
                <a className="text-gray-700 transition hover:text-gray-700/75" href="#">SALWAR KAMEEZ
                </a>
              </li>
              ...
              <li>
                <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> LEHENGA </a>
              </li>
            </ul>
          </div>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="mt-8 space-y-4 text-sm">
              ...
              <li>
                <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Terms of use </a>
              </li>
